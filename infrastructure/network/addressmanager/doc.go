/*
Package addressmanager implements concurrency safe Nonsense address manager.

# Address Manager Overview

In order maintain the peer-to-peer Nonsense network, there needs to be a source
of addresses to connect to as nodes come and go. The Nonsense protocol provides
