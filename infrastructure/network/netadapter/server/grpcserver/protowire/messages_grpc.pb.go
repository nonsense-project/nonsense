...
type P2P_MessageStreamClient interface {
	Send(*NonsensedMessage) error
	Recv() (*NonsensedMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *NonsensedMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*NonsensedMessage, error) {
	m := new(NonsensedMessage)
...
func (x *p2PMessageStreamServer) Send(m *NonsensedMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*NonsensedMessage, error) {
	m := new(NonsensedMessage)
...
func (x *rPCMessageStreamClient) Send(m *NonsensedMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*NonsensedMessage, error) {
	m := new(NonsensedMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *NonsensedMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*NonsensedMessage, error) {
	m := new(NonsensedMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
