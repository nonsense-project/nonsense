...
import (
	...
	"github.com/nonsense-project/nonsense/v2/util/mstime"
	"github.com/pkg/errors"
)

func (x *NonsensedMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "NonsensedMessage_Version is nil")
	}
...
func (x *VersionMessage) toAppMessage() (appmessage.Message, error) {
	...
	//  Full nonsense nodes set SubnetworkId==nil
	if err != nil && !errors.Is(err, errorNil) {
		return nil, err
	}
...
func (x *NonsensedMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
