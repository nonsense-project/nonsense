...
//
// Clients are expected to build RequestMessages and wrap them in NonsensedMessage.
// (see messages.proto)
//
// Having received a RequestMessage, (wrapped in a NonsensedMessage) the RPC server
// will respond with a ResponseMessage (likewise wrapped in a NonsensedMessage)
...
// GetCurrentNetworkRequestMessage requests the network nonsensed is currently
// running against.
//
...
type GetBlockTemplateRequestMessage struct {
	...
	// Which nonsense address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether nonsensed thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when nonsensed
	// is not synced. That is because when nonsensed isn't in sync with the rest of
...
// GetPeerAddressesRequestMessage requests the list of known nonsensed addresses in
...
// peers currently connected to this nonsensed.
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this nonsensed initiated the connection
	...
	// The timestamp of when this peer connected to this nonsensed
...
// AddPeerRequestMessage adds a peer to nonsensed's outgoing connection list.
// This will, in most cases, result in nonsensed connecting to said peer.
...
// selected parent chain from some startHash to this nonsensed's current virtual
...
// this nonsensed's current virtual.
...
// nonsensed. Note that this number may decrease as pruning occurs.
...
//
// This call is only available when this nonsensed was started with `--utxoindex`
//
