...
func (x *NonsensedMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "NonsensedMessage_Addresses is nil")
	}
...
func (x *NonsensedMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
