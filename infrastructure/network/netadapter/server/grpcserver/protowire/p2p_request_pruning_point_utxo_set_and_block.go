...
func (x *NonsensedMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "NonsensedMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *NonsensedMessage_RequestPruningPointUTXOSet) fromAppMessage(
