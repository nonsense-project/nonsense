...
type grpcStream interface {
	Send(*protowire.NonsensedMessage) error
	Recv() (*protowire.NonsensedMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.NonsensedMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.NonsensedMessage) error {
