...
// installService attempts to install the nonsensed service. Typically this should
...
// removeService attempts to uninstall the nonsensed service. Typically this should
...
// startService attempts to Start the nonsensed service.
