...
func parseCommand(args []string, commandDescs []*commandDescription) (*protowire.NonsensedMessage, error) {
	...
	return generateNonsensedMessage(commandValue, commandDesc)
}
