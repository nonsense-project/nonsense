...
const (
	defaultLogFilename          = "nonsenseminer.log"
	defaultErrLogFilename       = "nonsenseminer_err.log"
	defaultTargetBlockRateRatio = 2.0
)

var (
	// Default configuration options
	defaultAppDir     = util.AppDir("nonsenseminer", false)
...
type configFlags struct {
	...
	LightDataset          bool     `long:"light-dataset" description:"Mine from the light cache instead of prebuilding the full dataset. Uses much less memory but hashes more slowly."`
