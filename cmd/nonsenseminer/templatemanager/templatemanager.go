...
func Set(template *appmessage.GetBlockTemplateResponseMessage, backendLog *logger.Backend, fullDataset bool) error {
	...
	currentState = pow.NewState(block.Header.ToMutable(), fullDataset)
