...
func ExampleAmount() {
	...
	// Output:
	// Zero Sompi: 0 NNN
	// 100,000,000 Sompi: 1 NNN
	// 100,000 Sompi: 0.001 NNN
}
...
func ExampleAmount_unitConversions() {
	...
	fmt.Println("Sompi to NNN:", amount)
	...
	// Sompi to NNN: 444333.222111 NNN
	// Sompi to MilliKLS: 444333222.111 mKLS
	// Sompi to MicroKLS: 444333222111 μNNN
