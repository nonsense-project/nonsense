...
import (
	...
	"github.com/nonsense-project/nonsense/v2/util/bech32"
)
...
const (
	...
	Bech32PrefixNonsense

	// Prefix for the dev network.
	Bech32PrefixNonsenseDev

	// Prefix for the test network.
	Bech32PrefixNonsenseTest

	// Prefix for the simulation network.
	Bech32PrefixNonsenseSim
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"nonsense":     Bech32PrefixNonsense,
	"nonsensedev":  Bech32PrefixNonsenseDev,
	"nonsensetest": Bech32PrefixNonsenseTest,
	"nonsensesim":  Bech32PrefixNonsenseSim,
}
...
// and a payload which encodes the nonsense network and address type. It is used
...
// with the passed nonsense network.
