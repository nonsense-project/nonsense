...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "nonsense:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35c8mx62u3l",
			encoded: "nonsense:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35c8mx62u3l",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixNonsense,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixNonsense)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixNonsense,
		},
		{
			name:    "mainnet p2pk 2",
			addr:    "nonsense:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cx7flvuzv",
			encoded: "nonsense:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cx7flvuzv",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixNonsense,
				[util.PublicKeySize]byte{
			...
			passedPrefix:   util.Bech32PrefixNonsense,
			expectedPrefix: util.Bech32PrefixNonsense,
		},
		{
			name:    "testnet p2pk",
			addr:    "nonsensetest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35cwtnp95ze",
			encoded: "nonsensetest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35cwtnp95ze",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixNonsenseTest,
				[util.PublicKeySize]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixNonsenseTest)
			},
			passedPrefix:   util.Bech32PrefixNonsenseTest,
			expectedPrefix: util.Bech32PrefixNonsenseTest,
		},

		// ECDSA P2PK tests.
		{
			name:    "mainnet ecdsa p2pk",
			addr:    "nonsense:q835ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35e2s5j8xs98r",
			encoded: "nonsense:q835ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35e2s5j8xs98r",
			valid:   true,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c, 0xaa}
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixNonsense)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixNonsense,
		},
		...
		},
		{
			...
			addr:           "nonsense:qr35ennsep3hxfe7lnz5ee7j5jgmkjswss74as46gx",
			valid:          false,
			passedPrefix:   util.Bech32PrefixNonsense,
			expectedPrefix: util.Bech32PrefixNonsense,
		},
		...
		{
			name:    "mainnet p2sh",
			addr:    "nonsense:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdz3qw5ugf7",
			encoded: "nonsense:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdz3qw5ugf7",
			valid:   true,
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixNonsense)
			},
			passedPrefix:   util.Bech32PrefixNonsense,
			expectedPrefix: util.Bech32PrefixNonsense,
		},
		{
			name:    "mainnet p2sh 2",
			addr:    "nonsense:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxwq98nmep",
			encoded: "nonsense:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxwq98nmep",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixNonsense,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixNonsense)
			},
			passedPrefix:   util.Bech32PrefixNonsense,
			expectedPrefix: util.Bech32PrefixNonsense,
		},
		{
			name:    "testnet p2sh",
			addr:    "nonsensetest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vxfltt45j7",
			encoded: "nonsensetest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vxfltt45j7",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixNonsenseTest,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixNonsenseTest)
			},
			passedPrefix:   util.Bech32PrefixNonsenseTest,
			expectedPrefix: util.Bech32PrefixNonsenseTest,
		},
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		{
			"nonsensesim:raskzctpv9skzctpv9skzctpv9skzctpvy37ct7zafpv9skzctpvyqfusatdg",
			util.Bech32PrefixNonsenseSim,
			"unknown address type",
		},
		{
			"nonsensesim:raskzcg62uftfgk",
			util.Bech32PrefixNonsenseSim,
			"unknown address type",
		},
		{
			"nonsensetest:qqq65mvpxcmajeq44n2n8vfn6u9f8l4zsyllsa7fye",
			util.Bech32PrefixNonsense,
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"nonsense", util.Bech32PrefixNonsense, false},
		{"nonsensetest", util.Bech32PrefixNonsenseTest, false},
		{"nonsensesim", util.Bech32PrefixNonsenseSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixNonsense, "nonsense"},
		{util.Bech32PrefixNonsenseTest, "nonsensetest"},
		{util.Bech32PrefixNonsenseSim, "nonsensesim"},
		{util.Bech32PrefixUnknown, ""},
	}
