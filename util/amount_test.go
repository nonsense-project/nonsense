...
func TestAmountCreation(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			amount:   100,
			valid:    true,
			expected: 100 * constants.SompiPerNonsense,
		},
		{
			name:     "fraction",
			amount:   0.01234567,
		...
		},
		{
			...
			valid:    true,
			expected: 55 * constants.SompiPerNonsense,
		},
		{
			name:     "rounding down",
...
func TestAmountMulF64(t *testing.T) {
	tests := []struct {
		...
		{
			name: "Multiply 0.1 NNN by 2",
			amt:  100e5, // 0.1 NNN
			mul:  2,
			res:  200e5, // 0.2 NNN
		},
		{
			name: "Multiply 0.2 NNN by 0.02",
			amt:  200e5, // 0.2 NNN
			mul:  1.02,
			res:  204e5, // 0.204 NNN
		},
