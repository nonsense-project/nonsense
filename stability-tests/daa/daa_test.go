...
const miningAddress = "nonsensedev:qrcqat6l9zcjsu7swnaztqzrv0s7hu04skpaezxk43y4etj8ncwfk89tjwc8f"
...
func runDAATest(t *testing.T, testName string, runDuration time.Duration,
	...
	tearDownNonsensed := common.RunNonsensedForTesting(t, "nonsensed-daa-test", rpcAddress)
	defer tearDownNonsensed()
