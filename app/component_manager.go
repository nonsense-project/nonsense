...
import (
	...
	"github.com/nonsense-project/nonsense/v2/app/protocol"
	"github.com/nonsense-project/nonsense/v2/app/rpc"
	"github.com/nonsense-project/nonsense/v2/domain"
	"github.com/nonsense-project/nonsense/v2/domain/consensus"
	"github.com/nonsense-project/nonsense/v2/domain/utxoindex"
	...
	"github.com/nonsense-project/nonsense/v2/infrastructure/network/connmanager"
	"github.com/nonsense-project/nonsense/v2/infrastructure/network/netadapter"
	"github.com/nonsense-project/nonsense/v2/infrastructure/network/netadapter/id"
	"github.com/nonsense-project/nonsense/v2/util/panics"
)

// ComponentManager is a wrapper for all the nonsensed services
...
// Start launches all the nonsensed services.
...
// Stop gracefully shuts down all the nonsensed services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("Nonsensed is already in the process of shutting down")
		return
	}

	log.Warnf("Nonsensed shutting down")
