...
// MsgTransactionNotFound defines a nonsense TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new nonsense transactionsnotfound message that conforms to the
