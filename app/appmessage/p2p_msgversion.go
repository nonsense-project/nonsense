...
var DefaultUserAgent = fmt.Sprintf("/nonsensed:%s/", version.Version())

// MsgVersion implements the Message interface and represents a nonsense version
...
// NewMsgVersion returns a new nonsense version message that conforms to the
