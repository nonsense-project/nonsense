...
// MsgRequestAnticone implements the Message interface and represents a nonsense
...
// NewMsgRequestAnticone returns a new nonsense RequestPastDiff message that conforms to the
