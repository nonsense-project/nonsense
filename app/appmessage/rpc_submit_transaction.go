...
// RPCTransaction is a nonsensed transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a nonsensed transaction input representation
...
// RPCScriptPublicKey is a nonsensed ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a nonsensed transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a nonsensed outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a nonsensed utxo entry representation meant to be used
// over RPC
