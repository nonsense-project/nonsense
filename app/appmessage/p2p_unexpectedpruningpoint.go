...
// MsgUnexpectedPruningPoint represents a nonsense UnexpectedPruningPoint message
...
// NewMsgUnexpectedPruningPoint returns a new nonsense UnexpectedPruningPoint message
