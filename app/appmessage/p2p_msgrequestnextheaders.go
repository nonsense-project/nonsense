...
// MsgRequestNextHeaders implements the Message interface and represents a nonsense
...
// NewMsgRequestNextHeaders returns a new nonsense RequestNextHeaders message that conforms to the
// Message interface.
