...
// MsgRequestRelayBlocks implements the Message interface and represents a nonsense
...
// NewMsgRequestRelayBlocks returns a new nonsense RequestRelayBlocks message that conforms to
