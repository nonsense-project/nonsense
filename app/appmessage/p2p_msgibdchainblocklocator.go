...
// MsgIBDChainBlockLocator implements the Message interface and represents a nonsense
...
// NewMsgIBDChainBlockLocator returns a new nonsense locator message that conforms to
