...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a nonsense
...
// NewMsgDoneBlocksWithTrustedData returns a new nonsense DoneBlocksWithTrustedData message that conforms to the
// Message interface.
