...
// MsgRequestTransactions implements the Message interface and represents a nonsense
...
// NewMsgRequestTransactions returns a new nonsense RequestTransactions message that conforms to
