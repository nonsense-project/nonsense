...
// nonsense Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a nonsense
// Addresses message.
...
// NewMsgAddresses returns a new nonsense Addresses message that conforms to the
