...
// MsgDoneHeaders implements the Message interface and represents a nonsense
...
// NewMsgDoneHeaders returns a new nonsense DoneIBDBlocks message that conforms to the
// Message interface.
