...
// MsgRequestAddresses implements the Message interface and represents a nonsense
...
// NewMsgRequestAddresses returns a new nonsense RequestAddresses message that conforms to the
