...
// MsgInvTransaction implements the Message interface and represents a nonsense
...
// NewMsgInvTransaction returns a new nonsense TxInv message that conforms to
