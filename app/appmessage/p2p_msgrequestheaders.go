...
// MsgRequestHeaders implements the Message interface and represents a nonsense
...
// NewMsgRequstHeaders returns a new nonsense RequestHeaders message that conforms to the
