...
func (v *transactionValidator) checkTransactionAmountRanges(tx *externalapi.DomainTransaction) error {
	...
	// as a sompi. One nonsense is a quantity of sompi as defined by the
	// sompiPerNonsense constant.
	...
	for _, txOut := range tx.Outputs {
		...
		// This is impossible for Nonsense, but perhaps possible if an alt increases
