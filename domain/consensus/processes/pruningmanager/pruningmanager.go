...
import (
	...
	"github.com/nonsense-project/nonsense/v2/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that nonsensed doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
