...
// SignatureScript creates an input signature script for tx to spend NNN sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend NNN sent
