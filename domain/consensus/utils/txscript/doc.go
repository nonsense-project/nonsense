...
nonsense transaction scripts.

# Script Overview

Nonsense transaction scripts are written in a stack-base, FORTH-like language.

The nonsense script language consists of a number of opcodes which fall into
...
Typical nonsense scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend nonsense.
