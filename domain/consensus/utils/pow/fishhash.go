...
var (
	// Nonsense uses an independent domain seed so its PoW cannot be replayed
	// against the upstream network.
	seed = [32]byte{
		0x8b, 0x3f, 0x87, 0x6e, 0x0c, 0xae, 0xf0, 0x2b,
		0x83, 0x6a, 0x40, 0x18, 0x24, 0x20, 0x3f, 0x32,
		0x4c, 0xa5, 0x72, 0x07, 0xba, 0x6c, 0x53, 0x43,
		0x09, 0xc5, 0x74, 0xc8, 0x36, 0xb4, 0x45, 0xc1,
	}
