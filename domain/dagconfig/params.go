...
import (
	...
	"github.com/nonsense-project/nonsense/v2/util/network"
...
// Params defines a Nonsense network by its parameters. These parameters may be
// used by Nonsense applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: the upstream Kaspa pruning-proof design
...
// MainnetParams defines the network parameters for the main Nonsense network.
var MainnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "nonsense-mainnet",
	...
	Prefix: util.Bech32PrefixNonsense,
...
// TestnetParams defines the network parameters for the test Nonsense network.
var TestnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "nonsense-testnet-1",
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixNonsenseTest,
...
// SimnetParams defines the network parameters for the simulation test Nonsense
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixNonsenseSim,
...
// DevnetParams defines the network parameters for the development Nonsense network.
var DevnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "nonsense-devnet",
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixNonsenseDev,
...
// ErrDuplicateNet describes an error where the parameters for a Nonsense
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Nonsense network")

var registeredNets = make(map[appmessage.NonsenseNet]struct{})

// Register registers the network parameters for a Nonsense network. This may
