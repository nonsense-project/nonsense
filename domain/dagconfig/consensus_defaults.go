...
const (
	...
	defaultMassPerTxByte           = constants.MassPerTxByte
	defaultMassPerScriptPubKeyByte = constants.MassPerScriptPubKeyByte
	defaultMassPerSigOp            = constants.MassPerSigOp
	...
	defaultSubsidyGenesisReward                    = 1 * constants.SompiPerNonsense
	defaultPreDeflationaryPhaseBaseSubsidy         = 20 * constants.SompiPerNonsense
	defaultDeflationaryPhaseBaseSubsidy            = 1_776_465_535
	...
	// Retained offset in the configured emission schedule (not Nonsense outage history)
