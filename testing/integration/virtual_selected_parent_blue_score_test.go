...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := nonsensed.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = nonsensed.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = nonsensed.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
